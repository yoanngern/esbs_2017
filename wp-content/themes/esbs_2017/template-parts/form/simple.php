    ...
    <form action="//europe-shall-be-saved.us14.list-manage.com/subscribe/post?u=c60044849e7354db163f217a2&amp;id=18a65a07d4"
        ...
        <div id="mc_embed_signup_scroll">
            ...
            <div class="mc-field-group input-group">
                ...
                <ul>
                    <li><input checked="checked" type="checkbox" value="1" name="group[3975][1]"
                               id="mce-group[3975]-3975-0"><label for="mce-group[3975]-3975-0">I want to join the
            ...
            <fieldset class="optional_fields">
                ...
                <div class="mc-address-group">
                    ...
                    <div class="mc-field-group size1of2">
                        <label for="mce-ADDRESS-state">State/Province</label>
                    ...
                    <div class="mc-field-group size1of2">
                        ...
                        <select name="ADDRESS[country]" id="mce-ADDRESS-country" class="">
                            ...
                            <option value="59" selected>Germany</option>
                ...
                <div class="mc-field-group size1of2">
                    ...
                    <div class="datefield">
                        <span class="subfield dayfield"><input class="datepart " type="text" pattern="[0-9]*" value=""
                                                               placeholder="DD" size="2" maxlength="2"
                                                               name="BIRTHDAY[day]" id="mce-BIRTHDAY-day"></span> /
                        <span class="subfield monthfield"><input class="datepart " type="text" pattern="[0-9]*" value=""
                                                                 placeholder="MM" size="2" maxlength="2"
                                                                 name="BIRTHDAY[month]" id="mce-BIRTHDAY-month"></span>
                        /
                        <span class="subfield yearfield"><input class="datepart " type="text" pattern="[0-9]*" value=""
                                                                placeholder="YYYY" size="4" maxlength="4"
                                                                name="BIRTHDAY[year]" id="mce-BIRTHDAY-year"></span>
